function calculatePension() {
  ...
  /*   if (!averageBaseSalaryInput.value || isNaN(averageBaseSalary) || averageBaseSalary <= 0) {
        ...
        if (document.getElementById('degree').value=="0") {
            alert('يرجى تحديد الرتبة العسكرية.');
            degree.focus();
            return;
         }
    ...
    document.getElementById('baseSalary1').textContent = ` الراتب الاسمي للرتبة العسكرية: ${Math.floor(baseSalary).toLocaleString()} دينار`;
